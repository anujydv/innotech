...
L.TileLayer.MBTiles = L.TileLayer.extend({
	...
	_openDB: function(buffer) {
		try {
			...
			// this._stmt = this._db.prepare('SELECT tile_data FROM (SELECT map.tile_column,map.tile_row,map.zoom_level,images.tile_data from map inner join images on images.tile_id=map.tile_id) WHERE zoom_level = :z AND tile_column = :x AND tile_row = :y');
